...
<body class="fix-header">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">产权表</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title">产权表</h3> 
    ...
    <script src="../plugins/bower_components/jsgrid/db-cqb.js"></script>
    <script src="js/jsgrid-init-cqb.js"></script>
    <!--Style Switcher -->
