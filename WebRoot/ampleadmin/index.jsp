...
<link
	...
	rel="stylesheet">
<!-- Calendar CSS -->
<link href="../plugins/bower_components/calendar/dist/fullcalendar.css"
	rel="stylesheet" />
<!-- animation CSS -->
...
<body class="fix-header">
							...
							<div class="row row-in">
								<div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
									<ul class="col-in">
										...
										<li class="col-last">
											<h3 class="m-t-15 text-right ">
												<span class="counter m-t-15">160</span>台
											</h3>
										</li>
										<li class="col-middle">
											<h4>使用中服务器</h4>
								...
								<div class="col-lg-3 col-sm-6 row-in-br">
									<ul class="col-in">
										...
										<li class="col-last">
											<h3 class="m-t-15 text-right ">
												<span class="counter m-t-15">40</span>台
											</h3>
										</li>
										<li class="col-middle">
											<h4>空闲服务器</h4>
								...
								<div class="col-lg-3 col-sm-6 row-in-br">
									<ul class="col-in">
										...
										<li class="col-last">
											<h3 class="m-t-15 text-right ">
												<span class="counter m-t-15">26</span>条
											</h3>
										</li>
										<li class="col-middle">
											<h4>告警日志</h4>
								...
								<div class="col-lg-3 col-sm-6  b-0">
									<ul class="col-in">
										...
										<li class="col-last">
											<h3 class="m-t-15 text-right ">
												<span class="counter m-t-15">365</span>天
											</h3>
										</li>
										<li class="col-middle">
											<h4>系统运行时间</h4>
					...
					<div class="col-md-12 col-lg-6 col-sm-12 col-xs-12">
						<div class="white-box">
							...
							<ul class="list-inline text-right">
								...
								<li>
									<h5>
										<i class="fa fa-circle m-r-5 text-danger"></i>Windows
									</h5>
								</li>
							</ul>
					...
					<div class="col-md-6 col-sm-6 col-lg-3 col-xs-12">
						...
						<div class="white-box">
							<div class="row">
								...
								<div class="col-xs-4">
									<div class="circle circle-md bg-success pull-right m-t-10">
					...
					<div class="col-md-8 col-lg-9">
						<div class="manage-users">
							<div class="sttabs tabs-style-iconbox">
								<nav>
								<ul>
									<li><a href="#section-iconbox-1" class="sticon ti-user"><span>Select
												Users</span></a></li>
									<li><a href="#section-iconbox-2" class="sticon ti-lock"><span>Set
									...
									<div class="p-20 row">
										...
										<div class="col-sm-6">
											<ul class="side-icon-text pull-right">
												<li><a href="#"><span
														class="circle circle-sm bg-success di"><i
											...
											<tbody>
												<tr class="advance-table-row active">
													...
													<td style="width: 60px;"><img
														src="../plugins/images/users/varun.jpg" class="img-circle"
														width="30" alt="user img" /></td>
													<td>Andrew Simons</td>
													<td>Modulator</td>
													<td>6 May 2016</td>
													<td>Gujrat, India</td>
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox8" type="checkbox"> <label
																for="checkbox8"> </label>
														</div>
													</td>
													<td><img src="../plugins/images/users/genu.jpg"
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox9" type="checkbox"> <label
																for="checkbox9"> </label>
														</div>
													</td>
													<td><img src="../plugins/images/users/sonu.jpg"
														alt="user img" class="img-circle" width="30" /></td>
													<td>Joshi Nirav</td>
													<td>Admin</td>
													<td>21 Mar 2001</td>
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox10" type="checkbox"> <label
																for="checkbox10"> </label>
														</div>
													</td>
													<td><img src="../plugins/images/users/pawandeep.jpg"
														alt="user img" class="img-circle" width="30" /></td>
													<td>Joshi Sunil</td>
													<td>Admin</td>
													<td>21 Mar 2004</td>
									...
									<div class="p-10 p-t-30 row">
										...
										<div class="col-sm-2 pull-right m-t-10">
											<a href="javascript:void(0);"
												...
												class="ti-arrow-right m-l-5"></i></a>
										</div>
									</div>
									</section>
										...
										<table class="table">
											...
											<tbody>
												<tr class="advance-table-row">
													...
													<td style="width: 40px;">
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox19" type="checkbox"> <label
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox12" type="checkbox"> <label
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox13" type="checkbox"> <label
										...
										<table class="table">
											...
											<tbody>
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox15" type="checkbox"> <label
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox17" type="checkbox"> <label
										...
										<table class="table">
											...
											<tbody>
												<tr class="advance-table-row">
													...
													<td style="width: 40px;">
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox23" type="checkbox"> <label
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox20" type="checkbox"> <label
												...
												<tr class="advance-table-row">
													...
													<td>
														<div class="checkbox checkbox-circle checkbox-info">
															<input id="checkbox21" type="checkbox"> <label
						...
						<div class="panel wallet-widgets">
							<div class="panel-body">
								<ul class="side-icon-text">
									<li class="m-0"><a href="#"><span
											class="circle circle-md bg-success di vm"><i
							...
							<ul class="wallet-list">
								<li><i class="icon-wallet"></i><a href="javascript:void(0)">Withdrow
										money</a></li>
								<li><i class="icon-handbag"></i><a
									href="javascript:void(0)">Shop Now</a></li>
								<li><i class="ti-archive"></i><a href="javascript:void(0)">Add
										funds</a></li>
								<li><i class=" ti-wallet"></i><a href="javascript:void(0)">Withdrow
										money</a></li>
								<li><i class="icon-wallet"></i><a href="javascript:void(0)">Withdrow
										money</a></li>
								<li><i class="icon-handbag"></i><a
						...
						<div class="panel">
							...
							<div class="p-20 text-center">
								...
								<ul class="dp-table m-t-30">
									<li><img src="../plugins/images/users/varun.jpg"
										alt="varun" width="60" data-toggle="tooltip"
										title="Varun Dhavan" class="img-circle"></li>
									<li><img src="../plugins/images/users/genu.jpg"
										alt="varun" width="60" data-toggle="tooltip"
										title="Varun Dhavan" class="img-circle"></li>
									<li><img src="../plugins/images/users/pawandeep.jpg"
										alt="varun" width="60" data-toggle="tooltip"
										title="Varun Dhavan" class="img-circle"></li>
									<li><a href="" class="circle circle-md bg-info di"
										data-toggle="tooltip" title="More">5+</a></li>
								</ul>
							</div>
							<hr>
								...
								<table class="table table-hover manage-u-table">
									...
									<tbody>
										<tr>
											...
											<td><span class="font-medium">Daniel Kristeen</span> <br />
											<span class="text-muted">Texas, Unitedd states</span></td>
											<td>Visual Designer <br />
											<span class="text-muted">Past : teacher</span></td>
											<td>daniel@website.com <br />
						...
						<div class="panel">
							<div class="p-20">
								<div class="row">
									...
									<div class="col-xs-6">
										<a href="javascript:void(0)"
											class="pull-right btn btn-rounded btn-danger m-t-15"
							...
							<div class="panel-footer">
								<ul class="list-task todo-list list-group m-b-0"
									...
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputSchedule"
												name="inputCheckboxesSchedule"> <label
												for="inputSchedule"> <span>Schedule meeting
													with</span>
											</label>
										</div>
										<ul class="assignedto">
											<li><img src="../plugins/images/users/1.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Steave" /></li>
											<li><img src="../plugins/images/users/2.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Jessica" /></li>
											<li><img src="../plugins/images/users/3.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Priyanka" /></li>
											<li><img src="../plugins/images/users/4.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Selina" /></li>
										</ul>
									</li>
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputCall"
												name="inputCheckboxesCall"> <label for="inputCall">
												<span>Give Purchase report to</span> <span
												class="label label-danger label-rounded">Today</span>
											</label>
										</div>
										<ul class="assignedto">
											<li><img src="../plugins/images/users/3.jpg"
									...
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputBook"
												name="inputCheckboxesBook"> <label for="inputBook">
									...
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputForward"
												name="inputCheckboxesForward"> <label
												for="inputForward"> <span>Forward all tasks</span> <span
												class="label label-warning label-rounded">2 weeks</span>
											</label>
										</div>
										<div class="item-date">26 jun 2017</div>
									</li>
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputRecieve"
												name="inputCheckboxesRecieve"> <label
												for="inputRecieve"> <span>Recieve shipment</span>
											</label>
										</div>
										<div class="item-date">26 jun 2017</div>
									</li>
									<li class="list-group-item" data-role="task">
										<div class="checkbox checkbox-info">
											<input type="checkbox" id="inputForward2"
												name="inputCheckboxesd"> <label for="inputForward2">
												<span>Important tasks</span> <span
												class="label label-success label-rounded">2 weeks</span>
											</label>
										</div>
										<ul class="assignedto">
											<li><img src="../plugins/images/users/1.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Assign to Steave" /></li>
											<li><img src="../plugins/images/users/2.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Assign to Jessica" /></li>
											<li><img src="../plugins/images/users/4.jpg"
												alt="user img" data-toggle="tooltip" data-placement="top"
												title="Assign to Selina" /></li>
										</ul>
									</li>
								</ul>
							</div>
					...
					<div class="col-md-6 col-lg-3 col-xs-12 col-sm-6">
						...
						<div class="white-box">
							<div class="text-muted">
								...
								<a class="text-muted m-l-10" href="#"><i
									class="fa fa-heart-o"></i> 38</a>
							</div>
							<h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
							<p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper
								quam.</p>
							<button
							...
							<div class="panel-body">
								<div class="steamline">
									<div class="sl-item">
										...
										<div class="sl-right">
											<div>
												<a href="#">Tohnathan Doe</a> <span class="sl-date">5
													minutes ago</span>
											</div>
									...
									<div class="sl-item">
										...
										<div class="sl-right">
											<div>
												<a href="#">Hritik Roshan</a> <span class="sl-date">5
													minutes ago</span>
											</div>
											...
											<div class="row inline-photos">
												<div class="col-xs-4">
													<img class="img-responsive" alt="user"
														src="../plugins/images/small/vd1.jpg">
												</div>
												<div class="col-xs-4">
													<img class="img-responsive" alt="user"
														src="../plugins/images/small/vd2.jpg">
												</div>
												<div class="col-xs-4">
													<img class="img-responsive" alt="user"
														src="../plugins/images/small/vd3.jpg">
												</div>
											</div>
										</div>
									</div>
									<div class="sl-item">
										<div class="sl-left">
											<img class="img-circle" alt="user"
												src="../plugins/images/users/sonu.jpg">
										</div>
										<div class="sl-right">
											<div>
												<a href="#">Gohn Doe</a> <span class="sl-date">5
													minutes ago</span>
											</div>
									...
									<div class="sl-item">
										...
										<div class="sl-right">
											<div>
												<a href="#">Varun Dhavan</a> <span class="sl-date">5
													minutes ago</span>
											</div>
											<div class="desc">Contrary to popular belief</div>
										</div>
									...
									<div class="sl-item">
										...
										<div class="sl-right">
											<div>
												<a href="#">Tiger Sroff</a> <span class="sl-date">5
													minutes ago</span>
											</div>
											<div class="desc">
												The generated lorem ipsum <br>
												<a href="javascript:void(0)"
						...
						<div class="panel panel-themecolor">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a href="#" data-perform="panel-dismiss"><i
										class="ti-close"></i></a>
								</div>
							</div>
							<div class="panel-wrapper collapse in" aria-expanded="true"
								...
								<div class="panel-body">
									<div class="chat-box" style="height: 510px;">
										<ul class="chat-list slimscroll" style="overflow: hidden;"
											tabindex="5005">
											<li>
												<div class="chat-image">
													<img alt="male" src="../plugins/images/users/sonu.jpg">
												</div>
												<div class="chat-body">
													<div class="chat-text">
														<h4>Sonu Nigam</h4>
											...
											<li class="odd">
												<div class="chat-image">
													<img alt="Female" src="../plugins/images/users/genu.jpg">
												</div>
												<div class="chat-body">
													<div class="chat-text">
														<h4>Genelia</h4>
											...
											<li>
												<div class="chat-image">
													<img alt="male" src="../plugins/images/users/ritesh.jpg">
												</div>
												<div class="chat-body">
													<div class="chat-text">
														<h4>Ritesh</h4>
	...
	<script
		src='../plugins/bower_components/calendar/dist/fullcalendar.min.js'></script>
