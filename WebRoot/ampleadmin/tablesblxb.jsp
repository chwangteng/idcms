...
<body class="fix-header">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">设备类型表</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title">设备类型表</h3> 
    ...
    <script src="../plugins/bower_components/jsgrid/db-sblxb.js"></script>
    <script src="js/jsgrid-init-sblxb.js"></script>
    <!--Style Switcher -->
